        ...
        function() {
            ...
            if (!(e.length <= 0))
                for (var t = 0; t < e.length; t++) e[t].querySelector('[data-bs-toggle="price"]').addEventListener("change", function(e) {
                    for (var t = e.currentTarget.querySelector('input[type="checkbox"]'), r = e.currentTarget.parentNode.querySelectorAll("[data-monthly-price]"), a = e.currentTarget.parentNode.querySelectorAll("[data-annual-price]"), n = 0; n < r.length; n++) 1 == t.checked ? r[n].classList.add("d-none") : r[n].classList.remove("d-none");
            ...
            if (0 !== v.length)
                for (var e = function(e) {
                        ...
                        a.addEventListener("click", function(e) {
                            s = "play" === s ? (e.currentTarget.classList.add("ap-pause"), r.play(), requestAnimationFrame(p), "pause") : (e.currentTarget.classList.remove("ap-pause"), r.pause(), cancelAnimationFrame(i), "play")
                        });
                        ...
                        0 < r.readyState ? (d(), m(), f()) : r.addEventListener("loadedmetadata", function() {
                            d(), m(), f()
                            ...
                            r.currentTime = n.value, r.paused || requestAnimationFrame(p)
                        }), e.addEventListener("input", function(e) {
                            e = e.target.value;
                            r.volume = e / 100
                        })
